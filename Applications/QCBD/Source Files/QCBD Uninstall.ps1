...
$UninstallCode = $InstalledProducts | Where-Object ProductPath -like "QCBD Premier Enterprise client" | Select-Object ProductCode
...
msiexec /x $TrueUninstallCode /qn /l*v "C:\Temp\QCBDUninstall.Log"
